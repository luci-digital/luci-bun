...
void GlobalObject::addBuiltinGlobals(JSC::VM& vm)
{
    ...
    GlobalPropertyInfo staticGlobals[] = {
        ...
        GlobalPropertyInfo(builtinNames.CompressionStreamTransformerPrivateName(), JSCompressionStreamTransformerConstructor(), PropertyAttribute::DontDelete | PropertyAttribute::ReadOnly | 0),
