...
const setMaxHTTPHeaderSize = $newNativeFunction("node_http_binding.rs", "setMaxHTTPHeaderSize", 1);
const getMaxHTTPHeaderSize = $newNativeFunction("node_http_binding.rs", "getMaxHTTPHeaderSize", 0);
