...
const getBunServerAllClosedPromise = $newNativeFunction("node_http_binding.rs", "getBunServerAllClosedPromise", 1);
const sendHelper = $newNativeFunction("node_cluster_binding.rs", "sendHelperChild", 3);
